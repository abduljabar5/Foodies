...
exports.handler = async function(event, context) {
  ...
  const YELP_API_ENDPOINT = `https://api.yelp.com/v3/businesses/search?term=pizza&location=${encodedLocation}&rating=4,5&limit=10&sort_by=best_match`;  
  ...
  try {
    const yelpResponse = await axios.get(YELP_API_ENDPOINT, {
      headers: {
